...
TRAIN = "traces_out/malware_web_train.csv"
TEST = "traces_out/malware_web_test.csv"
VAL = "traces_out/malware_web_val.csv"
MODEL_CHECKPOINT_PATH = "models/malware_web_mixed_cleaned_dnn.keras"
CSV_LOGGER_PATH = "logs/malware_web_mixed_cleaned_dnn.csv"
MIN_LR = 1e-6
START_LR = 1e-3
BATCH_SIZE=32
EPOCHS=200
